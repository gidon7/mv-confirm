...
f.addElement("join_config_yn", SiteConfig.s("join_config_yn"), "hname:'가입 기본정보'");
...
f.addElement("join_minor_yn", SiteConfig.s("join_minor_yn"), "hname:'14세 미만 설정'");
...
f.addElement("join_user_nm_desc", SiteConfig.s("join_user_nm_desc"), "hname:'회원정보 성명 설명'");
f.addElement("join_addr_desc", SiteConfig.s("join_addr_desc"), "hname:'회원정보 주소 설명'");
f.addElement("join_mobile_desc", SiteConfig.s("join_mobile_desc"), "hname:'회원정보 휴대전화 설명'");
f.addElement("join_email_desc", SiteConfig.s("join_email_desc"), "hname:'회원정보 이메일 설명'");
f.addElement("join_dept_desc", SiteConfig.s("join_dept_desc"), "hname:'회원정보 소속 설명'");
...
f.addElement("join_etc1_status", SiteConfig.i("join_etc1_status"), "hname:'회원정보 기타1 상태'");
f.addElement("join_etc2_status", SiteConfig.i("join_etc2_status"), "hname:'회원정보 기타2 상태'");
f.addElement("join_etc3_status", SiteConfig.i("join_etc3_status"), "hname:'회원정보 기타3 상태'");
f.addElement("join_etc4_status", SiteConfig.i("join_etc4_status"), "hname:'회원정보 기타4 상태'");
f.addElement("join_etc5_status", SiteConfig.i("join_etc5_status"), "hname:'회원정보 기타5 상태'");
f.addElement("join_etc1_type", SiteConfig.s("join_etc1_type"), "hname:'회원기타필드1 유형'");
f.addElement("join_etc2_type", SiteConfig.s("join_etc2_type"), "hname:'회원기타필드2 유형'");
f.addElement("join_etc3_type", SiteConfig.s("join_etc3_type"), "hname:'회원기타필드3 유형'");
f.addElement("join_etc4_type", SiteConfig.s("join_etc4_type"), "hname:'회원기타필드4 유형'");
f.addElement("join_etc5_type", SiteConfig.s("join_etc5_type"), "hname:'회원기타필드5 유형'");
f.addElement("join_etc1_default", SiteConfig.s("join_etc1_default"), "hname:'회원기타필드1 값'");
f.addElement("join_etc2_default", SiteConfig.s("join_etc2_default"), "hname:'회원기타필드2 값'");
f.addElement("join_etc3_default", SiteConfig.s("join_etc3_default"), "hname:'회원기타필드3 값'");
f.addElement("join_etc4_default", SiteConfig.s("join_etc4_default"), "hname:'회원기타필드4 값'");
f.addElement("join_etc5_default", SiteConfig.s("join_etc5_default"), "hname:'회원기타필드5 값'");
f.addElement("modify_etc1_status", SiteConfig.s("modify_etc1_status"), "hname:'회원기타필드1 정보수정설정'");
f.addElement("modify_etc2_status", SiteConfig.s("modify_etc2_status"), "hname:'회원기타필드2 정보수정설정'");
f.addElement("modify_etc3_status", SiteConfig.s("modify_etc3_status"), "hname:'회원기타필드3 정보수정설정'");
f.addElement("modify_etc4_status", SiteConfig.s("modify_etc4_status"), "hname:'회원기타필드4 정보수정설정'");
f.addElement("modify_etc5_status", SiteConfig.s("modify_etc5_status"), "hname:'회원기타필드5 정보수정설정'");
...
f.addElement("company_nm", info.s("company_nm"), "hname:'회사명'");
...
f.addElement("boda_yn", SiteConfig.s("boda_yn"), "hname:'보다 사용여부'");
f.addElement("boda_company_id", SiteConfig.s("boda_company_id"), "hname:'보다조직아이디'");
f.addElement("boda_company_auth_cd", SiteConfig.s("boda_company_auth_cd"), "hname:'보다조직인증코드'");
f.addElement("boda_template0", SiteConfig.s("boda_template0"), "hname:'화상강의템플릿번호'");
f.addElement("boda_template1", SiteConfig.s("boda_template1"), "hname:'문서강의템플릿번호'");
f.addElement("boda_template2", SiteConfig.s("boda_template2"), "hname:'칠판강의템플릿번호'");
...
f.addElement("sms_access", info.s("sms_access"), "hname:'네이버 SMS 접근키'");
...
if(m.isPost() && f.validate()) {
	...
	site.item("sms_access", f.get("sms_access"));
	...
	SiteConfig.put("join_config_yn", f.get("join_config_yn"));
	...
	SiteConfig.put("join_user_nm_desc", f.get("join_user_nm_desc"));
	SiteConfig.put("join_addr_desc", f.get("join_addr_desc"));
	SiteConfig.put("join_mobile_desc", f.get("join_mobile_desc"));
	SiteConfig.put("join_email_desc", f.get("join_email_desc"));
	SiteConfig.put("join_dept_desc", f.get("join_dept_desc"));
	...
	SiteConfig.put("join_minor_yn", f.get("join_minor_yn"));
	...
	SiteConfig.put("join_etc1_status", f.get("join_etc1_status"));
	SiteConfig.put("join_etc2_status", f.get("join_etc2_status"));
	SiteConfig.put("join_etc3_status", f.get("join_etc3_status"));
	SiteConfig.put("join_etc4_status", f.get("join_etc4_status"));
	SiteConfig.put("join_etc5_status", f.get("join_etc5_status"));

	SiteConfig.put("modify_etc1_status", f.get("modify_etc1_status"));
	SiteConfig.put("modify_etc2_status", f.get("modify_etc2_status"));
	SiteConfig.put("modify_etc3_status", f.get("modify_etc3_status"));
	SiteConfig.put("modify_etc4_status", f.get("modify_etc4_status"));
	SiteConfig.put("modify_etc5_status", f.get("modify_etc5_status"));

	SiteConfig.put("join_etc1_type", f.get("join_etc1_type"));
	SiteConfig.put("join_etc2_type", f.get("join_etc2_type"));
	SiteConfig.put("join_etc3_type", f.get("join_etc3_type"));
	SiteConfig.put("join_etc4_type", f.get("join_etc4_type"));
	SiteConfig.put("join_etc5_type", f.get("join_etc5_type"));

	SiteConfig.put("join_etc1_default", f.get("join_etc1_default"));
	SiteConfig.put("join_etc2_default", f.get("join_etc2_default"));
	SiteConfig.put("join_etc3_default", f.get("join_etc3_default"));
	SiteConfig.put("join_etc4_default", f.get("join_etc4_default"));
	SiteConfig.put("join_etc5_default", f.get("join_etc5_default"));

	SiteConfig.put("join_dept_status", f.get("join_dept_status"));
	SiteConfig.put("modify_dept_status", f.get("modify_dept_status"));
	...
	SiteConfig.put("boda_yn", f.get("boda_yn", "N"));
	SiteConfig.put("boda_company_id", f.get("boda_company_id"));
	SiteConfig.put("boda_company_auth_cd", f.get("boda_company_auth_cd"));
	SiteConfig.put("boda_template0", f.get("boda_template0"));
	SiteConfig.put("boda_template1", f.get("boda_template1"));
	SiteConfig.put("boda_template2", f.get("boda_template2"));
