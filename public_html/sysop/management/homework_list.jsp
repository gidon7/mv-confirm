...
if("mod".equals(m.rs("mode")) && m.isPost()) {
	...
	while(homeworks.next()) {
		...
		if(!"".equals(homeworks.s("open_date"))) courseModule.item("open_date", Malgn.time("yyyyMMdd", homeworks.s("open_date")) + homeworks.s("open_date_hour") + homeworks.s("open_date_min") + "00");
		else courseModule.item("open_date", "");
