...
if("excel".equals(m.rs("mode"))) {
	...
	ex.setData(list, new String[] { "__ord=>No", "user_nm=>회원명", "login_id=>회원아이디", "study_time_conv=>학습시간", "progress_ratio_conv=>진도율", "complete_date_conv=>완료일시", "complete_yn=>출석여부" }, info.s("lesson_nm") + "_출석현황(" + m.time("yyyy-MM-dd") + ")");
	ex.write();
	return;
}
