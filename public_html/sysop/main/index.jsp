...
DataSet requestCourses = course.query(
	...
	+ " WHERE status = 1 AND display_yn = 'Y' AND site_id = " + siteId + " AND request_sdate <= " + sysNow + " AND request_edate >= " + sysNow + " "
...
while(requestCourses.next()) {
	...
	requestCourses.put("request_sdate_conv", m.time("yyyy.MM.dd HH:mm", requestCourses.s("request_sdate")));
	requestCourses.put("request_edate_conv", m.time("yyyy.MM.dd HH:mm", requestCourses.s("request_edate")));
