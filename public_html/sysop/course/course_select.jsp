...
if(!"".equals(f.get("s_req_sdate"))) lm.addWhere("a.request_edate >= '" + Malgn.time("yyyyMMdd", f.get("s_req_sdate")) + "235959'");
if(!"".equals(f.get("s_req_edate"))) lm.addWhere("a.request_sdate <= '" + Malgn.time("yyyyMMdd", f.get("s_req_edate")) + "000000'");
