...
if("R".equals(cinfo.s("course_type"))) {
	cinfo.put("request_date", m.time("yyyy.MM.dd HH:mm", cinfo.s("request_sdate")) + " - " + m.time("yyyy.MM.dd HH:mm", cinfo.s("request_edate")));
	cinfo.put("request_sdate_conv", m.time("yyyy.MM.dd HH:mm", cinfo.s("request_sdate")));
	cinfo.put("request_edate_conv", m.time("yyyy.MM.dd HH:mm", cinfo.s("request_edate")));
...
while(pcourses.next()) {
	...
	pcourses.put("request_sdate_conv", m.time("yyyy.MM.dd HH:mm", pcourses.s("request_sdate")));
	pcourses.put("request_edate_conv", m.time("yyyy.MM.dd HH:mm", pcourses.s("request_edate")));
