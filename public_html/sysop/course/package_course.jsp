...
if("R".equals(info.s("course_type"))) {
	info.put("request_date", m.time("yyyy.MM.dd HH:mm", info.s("request_sdate")) + " - " + m.time("yyyy.MM.dd HH:mm", info.s("request_edate")));
	info.put("request_sdate_conv", m.time("yyyy.MM.dd HH:mm", info.s("request_sdate")));
	info.put("request_edate_conv", m.time("yyyy.MM.dd HH:mm", info.s("request_edate")));
