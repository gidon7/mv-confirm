...
if("R".equals(cinfo.s("course_type"))) {
	cinfo.put("request_date", Malgn.time("yyyy.MM.dd HH:mm", cinfo.s("request_sdate")) + " - " + Malgn.time("yyyy.MM.dd HH:mm", cinfo.s("request_edate")));
	cinfo.put("request_sdate_conv", Malgn.time("yyyy.MM.dd HH:mm", cinfo.s("request_sdate")));
	cinfo.put("request_edate_conv", Malgn.time("yyyy.MM.dd HH:mm", cinfo.s("request_edate")));
...
while(list.next()) {
	...
	list.put("twoway_block", "16".equals(list.s("lesson_type")));
...
p.setVar("twoway_block", "Y".equals(SiteConfig.s("boda_yn")));
