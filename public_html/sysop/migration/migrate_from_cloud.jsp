...
if(m.isPost() && "preview".equals(f_mode)) {
    ...
    if(cloudData != null) {
        ...
        try {
            ...
            Malgn.errorLog("{migration.migrate_frome_cloud} IOException : " + ioe.getMessage(), ioe);
            isError = true;
        } finally {
            br.close();
        }
...
public void saveMap(String tableName, JSONObject data) throws Exception {
    String fileDir = "/home/lms/migration/";
    Writer fin = null;
    if(data == null) return;
    try {
        //폴더유무확인
        ...
        Malgn.errorLog("{migration.migrate_frome_cloud} IOException : " + uee.getMessage(), uee);
    } catch(IOException ioe) {
        Malgn.errorLog("{migration.migrate_frome_cloud} IOException : " + ioe.getMessage(), ioe);
    } finally {
