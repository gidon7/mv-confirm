...
//기록-개인정보조회
if("".equals(m.rs("mode")) && cuinfo.size() > 0 && !isBlindUser) _log.add("V", "수강정보", cuinfo.size(), inquiryPurpose, cuinfo);
...
if(m.isPost() && f.validate()) {
	...
	if("poplayer".equals(m.rs("ch"))) { m.js("parent.location.reload(); parent.CloseLayer();"); return; }
