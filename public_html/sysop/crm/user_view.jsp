...
info.put("guardian_type", Malgn.getItem(info.s("guardian_type"), user.guardianType));
info.put("guardian_mobile_conv", info.s("guardian_mobile"));
...
//기록-개인정보조회
if(!isBlindUser) _log.add("V", "회원정보 상세조회", 1, inquiryPurpose, info);
