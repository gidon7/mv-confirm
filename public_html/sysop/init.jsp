...
catch (RuntimeException re) { m.errorLog("RuntimeException 오류"); return; }
catch (Exception ex) { m.errorLog("제한 용량 초과"); return; }
...
boolean isDevServer = -1 < request.getServerName().indexOf("goe.malgn.co.kr");
...
boolean isMinorYn = "Y".equals(SiteConfig.s("join_minor_yn"));
...
p.setVar("SYS_MINOR_YN", isMinorYn);
