...
if(m.isPost() && f.validate()) {
	...
	//기록-개인정보조회
	_log.add("C", Menu.menuNm, 1, inquiryPurpose);

	//회원로그
	UserLogDao userLog = new UserLogDao(siteId, "user_insert");
	if(!userLog.add(userId, newId, "C", "회원등록", f)) {
		Malgn.errorLog("{user.user_insert} actionLog add error : user_id = " + userId + ", user_insert_id = " + newId);
	}
