...
if(m.isPost()) {
	...
	String[] required = { "col0", "col1", "col2", "col3" };
	...
	if("register".equals(f.get("mode"))) {
		...
		while(records.next()) {
			...
			if(flag) {
				...
				*/
				String birthday = (8 != records.s("col5").length() ? "" : m.time("yyyyMMdd", records.s("col5")));
				...
				user.item("gender", !"".equals(records.s("col6")) ? records.s("col6") : "0");
