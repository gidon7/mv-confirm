...
//기록-개인정보조회
if(info.size() > 0 && !isBlindUser) _log.add("V", Menu.menuNm, info.size(), inquiryPurpose, info);
...
f.addElement("account_no", Pattern.matches(".*[a-zA-Z].*", info.s("account_no")) ? SimpleAES.decrypt(info.s("account_no")) : info.s("account_no"), "hname:'은행계좌'");
...
if(m.isPost() && f.validate()) {
	...
	refund.item("account_no", SimpleAES.encrypt(f.get("account_no")));
